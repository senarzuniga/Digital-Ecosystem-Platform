...
TYPE_LIBRARY: Dict[str, Dict[str, Any]] = {
    ...
    "ingetrans_smart": {
        "label": "Ingetrans Smart Rail-less Reel Logistics",
        "throughput_unit": "reel_moves/h",
        "throughput_baseline": 8.8,
        "throughput_floor": 5.2,
        "throughput_ceiling": 11.0,
        ...
        "must_signals": [
            ...
            "station_positioning_error_mm",
            "navigation_localization_quality",
            "protective_field_intrusions",
            "wheel_motor_current_a",
            "starvation_events",
        ],
